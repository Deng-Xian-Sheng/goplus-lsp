...
func run(t *testing.T, input string) bool {
	...
	hint = fmt.Sprintf("To dump SSA representation, run:\n%% go build github.com/Deng-Xian-Sheng/goplus-lsp/cmd/ssadump && ./ssadump -test -build=CFP %s\n", input)
	...
	hint = fmt.Sprintf("To trace execution, run:\n%% go build github.com/Deng-Xian-Sheng/goplus-lsp/cmd/ssadump && ./ssadump -build=C -test -run --interp=T %s\n", input)
