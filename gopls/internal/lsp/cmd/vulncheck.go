...
import (
	...
	vulnchecklib "github.com/Deng-Xian-Sheng/goplus-lsp/gopls/internal/vulncheck"
...
func (v *vulncheck) DetailedHelp(f *flag.FlagSet) {
	...
	github.com/Deng-Xian-Sheng/goplus-lsp/gopls/internal/lsp/command.VulncheckResult
	message.
	Example:
