...
```sh
GO111MODULE=on go install github.com/Deng-Xian-Sheng/goplus-lsp/gopls@vX.Y.Z
```
...
go get -d github.com/Deng-Xian-Sheng/goplus-lsp/gopls@master github.com/Deng-Xian-Sheng/goplus-lsp@master

go install github.com/Deng-Xian-Sheng/goplus-lsp/gopls
```
...
```
$ go install github.com/Deng-Xian-Sheng/goplus-lsp/gopls@latest
```
