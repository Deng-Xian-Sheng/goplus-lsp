...
func doMain(write bool) (bool, error) {
	...
	sourceDir, err := pkgDir("github.com/Deng-Xian-Sheng/goplus-lsp/gopls/internal/lsp/source")
	if err != nil {
		return false, err
	}
	...
	goplsDir, err := pkgDir("github.com/Deng-Xian-Sheng/goplus-lsp/gopls")
	if err != nil {
		return false, err
	}
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(&buf, "// Code generated by \"github.com/Deng-Xian-Sheng/goplus-lsp/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = ")
	if err := printsrc.NewPrinter("github.com/Deng-Xian-Sheng/goplus-lsp/gopls/internal/lsp/source").Fprint(&buf, api); err != nil {
		return nil, err
	}
