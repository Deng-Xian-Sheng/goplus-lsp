...
```
map[github.com/Deng-Xian-Sheng/goplus-lsp/gopls/internal/lsp/protocol.DocumentURI]*github.com/Deng-Xian-Sheng/goplus-lsp/gopls/internal/govulncheck.Result
```
