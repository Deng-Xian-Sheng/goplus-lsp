...
const this = "github.com/Deng-Xian-Sheng/goplus-lsp/refactor/importgraph"

func TestBuild(t *testing.T) {
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/Deng-Xian-Sheng/goplus-lsp/refactor/importgraph", Files: packagestest.MustCopyFileTree(".")}})
