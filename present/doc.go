...
which can be slide presentations as in github.com/Deng-Xian-Sheng/goplus-lsp/cmd/present
...
*/
package present // import "github.com/Deng-Xian-Sheng/goplus-lsp/present"
