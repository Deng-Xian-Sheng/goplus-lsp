...
// Options is github.com/Deng-Xian-Sheng/goplus-lsp/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/Deng-Xian-Sheng/goplus-lsp/imports.Process with explicit context in opt.Env.
