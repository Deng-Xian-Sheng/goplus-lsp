...
`)
	...
	codeErrorTest(t, `./bar.gop:3:2: no required module provides package github.com/Deng-Xian-Sheng/goplus-lsp/gop/fmt2; to add it:
	go get github.com/Deng-Xian-Sheng/goplus-lsp/gop/fmt2
`, `
import (
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop/fmt2"
)
`)
}
