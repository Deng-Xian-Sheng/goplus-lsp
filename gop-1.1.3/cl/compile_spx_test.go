...
func lookupClass(ext string) (c *gopmod.Class, ok bool) {
	...
	case ".tgmx", ".tspx":
		return &gopmod.Class{
			...
			PkgPaths: []string{"github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/spx", "math"}}, true
	case ".t2gmx", ".t2spx":
		return &gopmod.Class{
			ProjExt: ".t2gmx", WorkExt: ".t2spx",
			PkgPaths: []string{"github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/spx2"}}, true
	}
	return
}
...
import (
	fmt "fmt"
	spx "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/spx"
)
...
import (
	fmt "fmt"
	spx2 "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/spx2"
)
...
import spx2 "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/spx2"
