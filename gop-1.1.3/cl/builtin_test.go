...
func TestGmxSettings(t *testing.T) {
	...
	if e := err.Error(); e != `github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/libc.Gop_game not found` {
		t.Fatal("newGmx:", e)
	}
}
...
func lookupClassErr(ext string) (c *gopmod.Class, ok bool) {
	...
	case ".t2gmx", ".t2spx":
		return &gopmod.Class{
			ProjExt: ".t2gmx", WorkExt: ".t2spx",
			PkgPaths: []string{"github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/libc"}}, true
	}
	return
}
