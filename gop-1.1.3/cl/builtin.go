...
func newBuiltinDefault(pkg *gox.Package, conf *gox.Config) *types.Package {
	...
	fmt := pkg.Import("fmt")
	os := pkg.Import("os")
	buil := pkg.Import("github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin")
	ng := pkg.Import("github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin/ng")
	iox := pkg.Import("github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin/iox")
	pkg.Import("strconv")
	pkg.Import("strings")
