...
import (
	...
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop"
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl"
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop/parser"
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop/parser/parsertest"
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop/scanner"
	"github.com/Deng-Xian-Sheng/goplus-lsp/gop/token"
...
func init() {
	...
	gblConf = &cl.Config{
		...
		LookupPub:     lookupPub,
		C2goBase:      "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal",
		NoFileLine:    true,
		NoAutoGenMain: true,
	}
}
...
func gopClTestFS(t *testing.T, conf *cl.Config, fs parser.FileSystem, pkgname, expected string) {
	...
	bar := pkgs[pkgname]
	pkg, err := cl.NewPackage("github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl", bar, conf)
	if err != nil {
...
import (
	fmt "fmt"
	os "os"
	iox "github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin/iox"
)
...
func TestAutoProperty(t *testing.T) {
	gopClTest(t, `import "github.com/Deng-Xian-Sheng/goplus-lsp/gop/ast/goptest"
...
import (
	fmt "fmt"
	goptest "github.com/Deng-Xian-Sheng/goplus-lsp/gop/ast/goptest"
	gopq "github.com/Deng-Xian-Sheng/goplus-lsp/gop/ast/gopq"
)
...
import ng "github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin/ng"
...
import (
	ng "github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin/ng"
	big "math/big"
)
...
import spx "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/spx"
...
func TestImportGopPkg(t *testing.T) {
	...
	removeAutogenFiles()
	gopClTest(t, `import "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/gop-in-go/foo"
...
import (
	fmt "fmt"
	foo "github.com/Deng-Xian-Sheng/goplus-lsp/gop/cl/internal/gop-in-go/foo"
)
...
import (
	fmt "fmt"
	builtin "github.com/Deng-Xian-Sheng/goplus-lsp/gop/builtin"
)
