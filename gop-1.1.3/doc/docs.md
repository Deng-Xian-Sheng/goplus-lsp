...
How these `ErrWrap expressions` work? See [Error Handling](https://github.com/Deng-Xian-Sheng/goplus-lsp/gop/wiki/Error-Handling) for more information.
...
Here is [an example to show how Go+ interacts with C](https://github.com/Deng-Xian-Sheng/goplus-lsp/gop/tree/v1.1/testdata/helloc2go).
