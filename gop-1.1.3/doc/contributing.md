...
Here are [list of Go+ Contributors](https://github.com/Deng-Xian-Sheng/goplus-lsp/gop/wiki/Goplus-Contributors). We award an email account (XXX@goplus.org) for every contributor. And we suggest you commit code by using this email account:
...
* [![Issues](https://img.shields.io/badge/ISSUEs-Go+-blue.svg)](https://github.com/Deng-Xian-Sheng/goplus-lsp/gop/issues)
...
* [![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/Deng-Xian-Sheng/goplus-lsp/gop)](https://www.tickgit.com/browse?repo=github.com/Deng-Xian-Sheng/goplus-lsp/gop)
