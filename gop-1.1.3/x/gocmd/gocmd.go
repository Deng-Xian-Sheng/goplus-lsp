...
const (
	ldFlagVersion   = "-X \"github.com/Deng-Xian-Sheng/goplus-lsp/gop/env.buildVersion=%s\""
	ldFlagBuildDate = "-X \"github.com/Deng-Xian-Sheng/goplus-lsp/gop/env.buildDate=%s\""
	ldFlagGopRoot   = "-X \"github.com/Deng-Xian-Sheng/goplus-lsp/gop/env.defaultGopRoot=%s\""
)
